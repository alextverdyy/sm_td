...
smtd.lib.smtd_keycode_to_str_uncertain.argtypes = [ctypes.c_uint16, ctypes.c_bool]
smtd.lib.smtd_keycode_to_str_uncertain.restype = ctypes.c_char_p
...
class TestDebugOutput(unittest.TestCase):
    def test_uncertain_custom_keycode_keeps_prefix(self):
        result = smtd.lib.smtd_keycode_to_str_uncertain(100, True).decode()
